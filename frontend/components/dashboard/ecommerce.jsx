                  ...
                  <CardHeader className='card-no-border'>
                    ...
                    <div className='media'>
                      <div className='media-body'>
                        <p>
                          <span className='f-w-500 font-roboto'>
                            {TodayTotalSale}
                          </span>
                ...
                <div className='media'>
                  <div className='media-body'>
                    <p>
                      ...
                      <span className='font-primary f-w-700 ml-2'>
                        {"99.00%"}
                      </span>
                    </p>
                    <h4 className='f-w-500 mb-0 f-26'>
                          ...
                          <td>
                            <div className='media'>
                              <img
                                ...
                                src={require("../../assets/images/dashboard-2/product-1.png")}
                                alt=''
                              />
                              <div className='media-body'>
                                <span>{HikeShoes}</span>
                        ...
                        <tr>
                          <td>
                            <div className='media'>
                              <img
                                className='img-fluid m-r-15 rounded-circle'
                                src={require("../../assets/images/dashboard-2/product-3.png")}
                                alt=''
                              />
                              <div className='media-body'>
                                <span>{TreePot}</span>
                        ...
                        <tr>
                          <td>
                            <div className='media'>
                              <img
                                className='img-fluid m-r-15 rounded-circle'
                                src={require("../../assets/images/dashboard-2/product-4.png")}
                                alt=''
                              />
                              <div className='media-body'>
                                <span>{Bag}</span>
                        ...
                        <tr>
                          <td>
                            <div className='media'>
                              <img
                                className='img-fluid m-r-15 rounded-circle'
                                src={require("../../assets/images/dashboard-2/product-5.png")}
                                alt=''
                              />
                              <div className='media-body'>
                                <span>{Watch}</span>
                        ...
                        <tr>
                          <td>
                            <div className='media'>
                              <img
                                className='img-fluid m-r-15 rounded-circle'
                                src={require("../../assets/images/dashboard-2/product-6.png")}
                                alt=''
                              />
                              <div className='media-body'>
                                <span>{TShirt}</span>
                ...
                <div className='activity-timeline'>
                  ...
                  <div className='media'>
                    ...
                    <div className='media-body'>
                      ...
                      <p className='font-roboto'>
                        {"Aenean sit amet magna vel magna fringilla ferme."}
                      </p>
                    </div>
                  </div>
                  <div className='media'>
                    ...
                    <div className='media-body'>
                      ...
                      <p className='font-roboto'>
                        {"Vestibulum nec mi suscipit, dapibus purus....."}
                      </p>
                    </div>
                  </div>
                  <div className='media'>
                    ...
                    <div className='media-body'>
                      ...
                      <p className='font-roboto'>
                        {"Curabitur egestas consequat lorem."}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className='apex-chart-container goal-status text-center row'>
                  <div className='rate-card col-xl-12'>
                    <div className='goal-chart'>
                      <ApexCharts
                        id='riskfactorchart'
                        options={Riskfactorchart.options}
                        series={Riskfactorchart.series}
                        type='radialBar'
                        height={350}
                      />
                    </div>
                  ...
                  <ul className='col-xl-12'>
                    ...
                    <li>
                      <div className='btn-download btn btn-gradient f-w-500'>
                        {DownloadDetails}
                      </div>
                    </li>
                  </ul>
