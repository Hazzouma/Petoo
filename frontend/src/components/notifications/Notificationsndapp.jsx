...
import { Container, Row, Col, Card, CardBody, CardHeader, Nav, NavItem, TabContent, TabPane, Table,Badge,Button } from 'reactstrap'
                                  ...
                                  <tbody>
                                    {appo.length  ?
                                      appo.map((appo, index) => {
                                        ...
                                        const petinfo= pets.find((pet,index) =>{
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          : ''}
                                      ...
                                      : <tr><td><div className="no-favourite"><span>You can trust our Vet list and take an appointment</span></div></td></tr>
                                    }
                                  </tbody>
                                </Table>
                              </div>
