                ...
                <Card>
                  ...
                  <CardBody>
                    <Form className="theme-form mega-form">
                      ...
                      <FormGroup>
                        ...
                        <Input className="form-control" type="text" placeholder="ex: cat, bird, dog..." />
                      </FormGroup>
                      <FormGroup>
                  ...
                  <Col>
                    ...
                    <div className="checkbox checkbox-primary">
                      ...
                      <FormGroup>
                        ...
                        <Input className="form-control" type="email" placeholder="Breed" />
                      </FormGroup>
                      <FormGroup>
                        <Label className="col-form-label">Color</Label>
                        <Input className="form-control" type="Number" placeholder="Color" />
                      </FormGroup>
                      <FormGroup>
                        <Label className="col-form-label">Distinguishing Mark</Label>
                        <Input className="form-control" type="Number" placeholder="ex: black tail/ dark spot on the back...." />
                      </FormGroup>
                      
                      <FormGroup>
                        <Label className="col-form-label">Known Allergies</Label>
                        <Input className="form-control" type="text" placeholder="Allergies" />
                      </FormGroup>
                  ...
                  <label className="pb-4">Vaccines done:</label>
                    <Form className="form-inline theme-form billing-form">
                      <FormGroup>
                        <Input className="form-control" type="text" placeholder="Vaccine name" />
                      </FormGroup>
                      <FormGroup className="form-row">
                          <label className="col-sm-3 col-form-label text-right">Date</label>
                          <div className="col-xl-5 col-sm-9">
                            <div className="input-group">
                              <DatePicker className="form-control digits" selected={startDate} onChange={handleChange} />
                            </div>
